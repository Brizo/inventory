<?php
  ...
  if (isset($_POST['remove'])) {
    ...
    $query = "DELETE from pool_items WHERE serialno = '".$_SESSION['serialno']."'";

    // check if server was deleted and define messages accordingly
    if ($run = mysql_query($query)) {
      $_SESSION['removePLSuccess'] = "Pool Item successfully removed";
      header('Location: pool_list.php');                         
    } else {
      $_SESSION['removePLFailure'] = "Problem encountered";
      header('Location: pool_list.php');
    }
          ...
          <div class="panel-body"> 
            <div class='row-fluid'>
              <div class="col-sm-6 col-sm-offset-3">
                <h2><center>REMOVE POOL ITEM</center></h2>
                <hr>

                <?php
                  $poolitem_serial = $_GET['id'];
                  $referer = $_SERVER['HTTP_REFERER'];

                  $query2 = "SELECT *  FROM pool_items WHERE serialno ='". $poolitem_serial."'";
                ...
                <div class="panel panel-success"> <!-- panel 2 starts -->
                  ...
                  <div class="panel-body">
                    Item : <?php echo $_SESSION['type']; ?><br>
                    Item Serial : <?php echo $_SESSION['serialno']; ?><br>
                    Asset No : <?php echo $_SESSION['assetno']; ?>
                  </div>
                
                  <div class="panel-footer">
                    <form action="remove_poolitem.php" method="post">
                      ...
                      <input type="hidden" name="serial" value="<?php echo $_SESSION['serialno']; ?>" />
                    </form>
                  </div>
                </div><!-- end panel 2 -->
