            ...
            <div class="row-fluid">
              <div class="col-sm-10 col-sm-offset-1">
                <div class="col-sm-6 col-sm-offset-3">
                  <h2><center>RAN OUT TONNERS</center></h2>
                  <hr> 
                </div>
                <div style="margin: 10px auto; padding-left: 5px;">                 
                  ...
                  <tbody>
                    <?php
                      $query = 'SELECT DISTINCT u.user_name as user,u.user_firstName as name, u.user_lastName as surname, p.p_comp as comp, 
                              p.p_model as pmodel, t.t_model as tmodel, t.t_color as tcolor, t.t_installeddate as inst, t.t_ranoutDate as ranout
                          FROM tonners t
                      ...
                      if (mysql_num_rows($result) == 0) {
                        ...
                        while ($row = mysql_fetch_array($result)){
                          $instDate = $row['inst'];
                          $ranoutDate = $row['ranout'];
                          $diff = strtotime($ranoutDate) - strtotime($instDate);
  $days =                 $days = floor($diff/(3600*24))." days";
